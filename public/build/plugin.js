...
$(document).ready(function(){
  ...
  $('.btn-registro').on('click', function(e) {
    if((document.getElementById('nombre').value).length < 4){
      ...
      $.smallBox({
        title:"¡Error!",
        content:"La contraseña debe contener tanto números, letras minúsculas y mayúsculas y simbolos especiales",
        colortime:2000,
        sound: false,
        colors:["#DE594C","#D0582A"],
      }); 
 ...
 $('.editar-datos').on('click',function(e){
  ...
  $('.eliminar-suscripcion1').on('click', function(e){
    $target = $(e.target);
    const numero = $target.attr('numero');
    const producto = $target.attr('id');
    const NumeroEntrante = $target.atrr('NumeroEntrante');
    $.smallBoxKill();
    $.smallBox({
        title:"¡Cuidado!",
        width: 500,
        ...
        $.ajax({
          ...
          url:'/admin/eliminar-suscripcion/' + producto + '/' + numero,
          success: function(result){
            window.location.href = "/users/suscripciones/"+NumeroEntrante;
          },
          error: function(err){
            console.log(err);
          }
      ...
      url: '/reenviarcontrasena/' + email,
       success: function(data, text, xhr) {
         if(data == 'OK') {
            ...
            $.smallBox({
              title:"¡Error!",
              content:"Puede que el correo ingresado sea incorrecto",
              colortime:2000,
              sound: false,
              colors:["#DE594C","#D0582A"],
            });	
  ...
  $('.cambiar-notificaciones').on('click',function(e){
   ...
   $('.cambiar-notificaciones1').on('click',function(e){
    $target = $(e.target);
    var shortcode = $(this).attr('data-shortcode');
    var numerovalue = document.getElementById('numerox').value;
     if(!numerovalue.match(/^[0-9]+$/)){
      alert('Debes ingresar un número');
      e.preventDefault();
    }else {
      $.ajax({
        ...
        success: function(data, text, xhr){
          if(data == 'OK'){
            $.smallBox({
              title:"¡Muy Bien!",
              content:"Se modificaron correctamente los datos, presiona en continuar",
              colortime:2000,
              width:450,
              colors:["#28A34F","#21AFAB"],
              buttons:["CONTINUAR"],
...
$('.iniciar_suscripcion').on('click', function(){
    ...
    if ($('input[name="producto"]').is(':checked')) {
        var i = 0;
      $('.checkbox:checked').each(
        function(){
          ...
          var operadorax = operadorax.replace(" ","");
          var operadoraux = $(this).attr('operadora');
          var operadoraux = operadoraux.replace(" ","");
          ...
          for(i=0 ; i<operadorax.length - 1; i++) {
            console.log(operadorax[i]);
            console.log(operadoraux[i]);
          ...
          if(comprobation == 1){
            ...
            success: function(data, text, xhr){
              if(data == "OK") {
                ...
                $.smallBox({
                  title:"¡Muy Bien!",
                  content:"Te has suscrito correctamente, presiona en continuar",
                  colortime:2000,
                  width:500,
                  colors:["#28A34F","#21AFAB"],
                  buttons:["CONTINUAR"],
                  ...
                  window.location.href = "/users/productos";
                });
              } else {
                $.smallBoxKill();
                $.smallBox({
